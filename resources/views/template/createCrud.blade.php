...
<body>
    <div class="mycard p-3">
        <div class="crud-content">
            <div class="container">
                <div class="row fw-bold p-2" style="font-size:1.5em;">@yield('crud-name')</div>
                <div class="row">
                    <form action="authLogin" method="post" class="login-form " name="file" id="name" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-1">
                            <input type="text" class="form-control" id="title" aria-describedby="titleHelp" name="titleTopikUtama" placeholder="judul...">
                        </div>
                        <div class="mb-3">
                            <label for="descriptionFormControlTextarea1" class="form-label"></label>
                            <textarea class="form-control" id="descriptionFormControlTextarea1" rows="20" placeholder="penjelasan..."></textarea>
                        </div>
                    </form>
                </div>
                <div class="row">
                ...
                <div class="row justify-content-center d-flex align-items-center">
                    ...
                    <div class="col ">
                        <a href="inputCreate" class="text-decoration-none">
                            <div class="submit d-flex justify-content-center align-items-center">
