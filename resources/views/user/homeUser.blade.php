...
<section class="home-section">
  ...
  <div id="topik-utama" class="" style="padding-bottom:60px">
    @forelse(TopikUtama::orderBy('created_at','desc')->paginate(1) as $post)
    <a class="text-decoration-none" style="color:black" href="/showTopikUtamaUser/{{$post->id}}">
  ...
  <div class="trending-topik" style="padding-top:40px;">
    ...
    <div class="row">
      @forelse(TrendingIsu::all() as $post)
      <div class="col-lg-4 pb-2">
        <div class="card h-90" style="">
          ...
          <div class="card-body">
            ...
            <a href="/showTrendingIsuUser/{{$post->id}}" class="btn btn-outline-primary" style="">Read more</a>
          </div>
        </div>
      </div>
      <!-- <div class="row">
