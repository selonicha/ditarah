...
<div class="mycard p-3">
    <div class="crud-content">
        <div class="container">
            <div class="row fw-bold p-2" style="font-size:1.5em;">Edit Kisah Inspiratif</div>
            <div class="row">
                <form action="/updateKisahInspiratif/{{ $kisahInspiratif['id'] }}" method="post" class="login-form" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                        <input type="text" class="form-control" id="title" aria-describedby="titleHelp" name="judul" value="{{$kisahInspiratif['judul']}}">
                    </div>
                    <div class="mb-1">
                        <input type="text" class="form-control" id="writer" aria-describedby="writerHelp" name="penulis" value="{{$kisahInspiratif['penulis']}}">
                    </div>
                    <div class="mb-3">
                        <label for="descriptionFormControlTextarea1" class="form-label"></label>
                        <textarea class="form-control" id="descriptionFormControlTextarea1" rows="20" name="penjelasan">{{$kisahInspiratif['penjelasan']}}</textarea>
                    </div>
                    <div class="row">
                        <fieldset class="upload_dropZone text-center mb-3 p-4">
                            ...
                            <img src="{{asset('storage/'.$kisahInspiratif['file'])}}" alt="" style="height:300px !important;width:600px !important;">
