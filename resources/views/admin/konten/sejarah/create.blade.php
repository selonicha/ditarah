...
<div class="mycard p-3">
    <div class="crud-content">
        <div class="container">
            <div class="row fw-bold p-2" style="font-size:1.5em;">Tambah Sejarah</div>
            <div class="row">
                <form action='createContentSejarah' method="POST" class="login-form" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="mb-3">
